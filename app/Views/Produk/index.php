                ...
                <div class="col-xs-12">
                    <div class="card border-success ">
                        <div class="card-header bg-success">
                            <h4 class="card-title" style="color:black;">Data Produk</h4>
                                    ...
                                    <div class="col-xs-12 col-md-center">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="btn-group mb-0.1 ml-0.1 " style="float:lefth; margin-top:-15px;">
                                                <a href="/c_produk/create" class="btn btn-info btn-outline-primary mb-0.1 ">Tambah Data</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <?php foreach ($produk as $k) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#del<?= $k['id'] ?>" class="btn btn-danger" data-toggle="modal">
                                                        Hapus
                                                    </a>
                                                    <a href="/c_produk/edit/<?= $k['id']; ?>" class=" btn btn-warning">Edit</a>
                                                    <a href="/c_produk/<?= $k['id']; ?>" class=" btn btn-primary">Lihat</a>
                                                    <!-- Modal -->
                                                    <div class="modal fade bd-example-modal-sm" id="del<?= $k['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-sm" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body" style="text-align: center;">
                                                                    Apakah Anda ingin Menghapus Data <b><?= $k['id']; ?></b>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <!-- <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button> -->
                                                                    <form action="/c_produk/delete/<?= $k['id']; ?>" method="POST" class="d-inline">
                                                                        <?= csrf_field(); ?>
